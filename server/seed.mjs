...
export const seed = {
  ...
  products: [
    { id: "chitu-b19", name: "Chitu B19系列", domainId: "wearables", stage: "VN2", supplyTimeText: "预计2026年1月初发货", defaultDeadline: "2026-08-31T18:00:00+08:00", enabled: true, version: 1, skus: [{ id: "b19f", model: "Chitu-B19F", bomCode: "111" }, { id: "b19w", model: "Chitu-B19W", bomCode: "222" }, { id: "b19fb", model: "Chitu-B19FB", bomCode: "333" }, { id: "b19d", model: "Chitu-B19D", bomCode: "444" }] },
    { id: "chitu-b21", name: "Chitu B21系列", domainId: "wearables", stage: "V3", supplyTimeText: "预计2026年2月中旬发货", defaultDeadline: "2026-09-15T18:00:00+08:00", enabled: true, version: 1, skus: [{ id: "b21f", model: "Chitu-B21F", bomCode: "521" }, { id: "b21w", model: "Chitu-B21W", bomCode: "522" }, { id: "b21d", model: "Chitu-B21D", bomCode: "523" }] },
    { id: "chitu-pad-x", name: "Chitu Pad X系列", domainId: "tablet", stage: "V4", supplyTimeText: "预计2026年3月初发货", defaultDeadline: "2026-09-30T18:00:00+08:00", enabled: true, version: 1, skus: [{ id: "padx-pro", model: "Chitu-PadX-Pro", bomCode: "PX01" }, { id: "padx-air", model: "Chitu-PadX-Air", bomCode: "PX02" }] },
    { id: "chitu-b23", name: "Chitu B23新品项目", domainId: "wearables", stage: "V3", supplyTimeText: "待产品线确认", defaultDeadline: null, enabled: true, version: 1, skus: [] },
  ],
  organizations: [
