...
export function ConfigurationPage({ products = [], domains = [], mssDomains = [], organizations = [], dictionaries = {}, users = [], currentUserRole = 'ADMIN', canEdit = true, canManageUsers = false, onAddProduct, onUpdateProduct, onAddDomain, onUpdateDomain, onAddOrganization, onUpdateOrganization, onAddDictionaryItem, onUpdateDictionaryItem, onDeleteDictionaryItem, onAddUser, onUpdateUser }) {
